...
public class MovementFeatures extends DataSetOperation {
	...
	public static void main(String[] args) throws Exception { DataSetOperator.operate(new MovementFeatures()); }
	...
	private static double calcAngularVelocity(Entry a, Entry b) {
		...
		if (timeDiff < 0) throw new Error("Time negative?!");
